...
class VacationRequest:
    """Organization vacation request — DynamoDB source of truth (not AttendanceRecord)."""
    ...
    related_vacation_id: UUID | None = None
    attention_codes: list[str] = field(default_factory=list)
    attention_detail: str | None = None
    # Peer vacation IDs currently overlapping this request (warning context).
