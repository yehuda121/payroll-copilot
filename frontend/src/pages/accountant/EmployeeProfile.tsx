...
type MonthTone = 'complete' | 'missing' | 'failed' | 'empty';
...
function groupDocumentTypes(collections: ProfileCollection[]): DocTypeCardModel[] {
...
function monthTone(row: MonthRow | undefined): MonthTone {
  if (!row) return 'empty';
