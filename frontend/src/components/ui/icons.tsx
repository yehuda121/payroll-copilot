...
export function PencilIcon({ className, size = 18, ...rest }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function SettingsIcon({ className, size = 18, ...rest }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function UploadIcon({ className, size = 18, ...rest }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function WarningTriangleIcon({ className, size = 22, ...rest }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function RefreshIcon({ className, size = 18, ...rest }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
